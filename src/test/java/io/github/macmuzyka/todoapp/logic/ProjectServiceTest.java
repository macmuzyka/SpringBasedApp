...
class ProjectServiceTest {
    ...
    void creteGroup_noMultipleGroupsConfig_And_undoneGroupExists_throwsIllegalStateException() {
        // given
        ...
        assertThat(exception)
                ...
                .hasMessageContaining("one unfinished Task Group");

    }

    @Test
    @DisplayName("Should throw IllegalArgumentException when configuration ok and no projects for a given id")
    void creteGroup_configurationOk_And_noProjects_throwsIllegalArgumentException() {
        // given
    ...
    @Test
    @DisplayName("Should throw IllegalArgumentException when when configured to allow just 1 group and no groups and no projects")
    void creteGroup_noMultipleConfig_And_andNoUndoneGroupExists_noProjects_throwsIllegalArgumentException() {
        // given
        var mockRepository = mock(ProjectRepository.class);
        when(mockRepository.findById(anyInt())).thenReturn(Optional.empty());
        // and
